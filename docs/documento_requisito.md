...
| I02 | O sistema deverá indicar quais produtos estão fora do inventário                                                                                                                                                               | RF                |
...
| I08 | O sistema deve conferir se o cpf do usuário é compatível e válido.                                                                                                                                                             | RF                |
| I09 |  O aplicativo deve fornecer um canal de suporte ao cliente para resolver quaisquer problemas ou dúvidas relacionadas ao pedido. Isso pode incluir chat em tempo real, e-mail ou telefone.                                      | RF                |
| I10 | O aplicativo deve oferecer as informações da intrega para o entregador dos produtos                                                                                                                                            | RF                |
| I11 | O sistema deve permitir que os usuários concluam uma compra, inserindo informações de pagamento e endereço de entrega                                                                                                          | RF                |
| I12 | O sistema deve informar o estoquista que que tal produto está sem estoque na automação                                                                                                                                         | RF                |
| I13 | O sistema deve ser capaz de identificar um produto através do seu QR CODE.                                                                                                                                                     | RF                |
| I14 | O sistema deve fornecer ao estoquista os itens mais vendidos do estoque                                                                                                                                                        | RF                |
| I15 | O usuário poderá fazer o cancelamento do pedido dentro do período de 10 minutos, caso processamento do pedido não tenha sido inicializado.                                                                                     | RNF               |
| I16 | O sistema deve ser flexível o suficiente para acomodar mudanças futuras, incluindo a adição ou remoção de recursos, funcionalidades e requisitos                                                                               | RNF               |
| I17 | O sistema deve impedir o funcionamento do sistema enquanto estiver sendo feito a reposição de estoque                                                                                                                          | RNF               |
| I18 | O sistema deve ser responsivo                                                                                                                                                                                                  | RNF               |
| I19 | O aplicativo deve ser intuitivo                                                                                                                                                                                                | RNF               |
| I20 | O aplicativo deve ser acessível                                                                                                                                                                                                | RNF               |
| I21 | O sistema deve impedir o funcionamento enquanto o usuário estiver pegando seu produto.                                                                                                                                         | RNF               |
| I22 | O aplicativo deve ser fácil de manter e atualizar, com um código limpo e documentação detalhada.                                                                                                                               | RNF               |
